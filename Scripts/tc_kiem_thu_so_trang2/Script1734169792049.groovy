...
WebUI.click(findTestObject('Object Repository/Page_zShop - Siu th k thut s My nh  Ph kin   cng/bdi_Khuyn Mi'))
verifyCurrentUrl('https://zshop.vn/khuyen-mai/')

WebUI.click(findTestObject('Object Repository/Page_zShop Khuyn mi R nht - Hot nht  Xem Ngay/span_Tip theo'))
WebUI.delay(3)
verifyCurrentUrl('https://zshop.vn/khuyen-mai/page-2/')

WebUI.click(findTestObject('Object Repository/Page_zShop Khuyn mi R nht - Hot nht  Xem Ngay/span_Trc'))
WebUI.delay(2)
verifyCurrentUrl('https://zshop.vn/khuyen-mai/')
WebUI.closeBrowser()
