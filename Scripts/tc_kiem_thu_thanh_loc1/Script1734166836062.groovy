...
WebUI.click(findTestObject('Object Repository/Page_kiem_thu_thanh_loc/bdi_Khuyn Mi'))

WebUI.click(findTestObject('Object Repository/Page_kiem_thu_thanh_loc/label_Intel Core i5 13th'))
WebUI.delay(3)
verifyCurrentUrl('https://zshop.vn/khuyen-mai/?features_hash=474-19855')
